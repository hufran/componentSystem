/**
 * @class: cloudsMark 暴风云视频剪辑工具类
 * @namespace: cloudsMark.animate 动画类
 */
let animate={
    /*
     MTween 作用，做运动
     ...
     方法：MTween(oList,'left',1000,l,'linear',function(){
     if(n===len-1){
     n=1;
    ...
    MTween:function(obj,attr,duration,target,fx,callBack){
        ...
        obj.timer=setInterval(function(){
            ...
            var value=animate.Tween[fx](t,b,c,d);
            if(t>=d){
    ...
    Tween:{
        ...
        easeInStrong:function(t,b,c,d){//加速曲线增强
